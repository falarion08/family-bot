...
gendered_terms = {'brother','sister','son','daughter','mother','father','aunt','uncle','grandfather','grandmother'}

ancestor_terms = {'mother','father','aunt','uncle','grandfather','grandmother'}
...
female_roles = {'sister','aunt','grandmother','daughter','mother'}

male_roles = {'son','uncle','grandfather','son','father'}
